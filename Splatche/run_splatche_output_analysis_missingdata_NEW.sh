...
scp -rp nas:/$path_to_dir/splatche_results_cluster_analysis_missingdata_NEW.R $path_to_tmp/
...
if [ $# != 0 ]
	...
	then
		/usr/local/bin/Rscript $path_to_tmp/splatche_results_cluster_analysis_missingdata_NEW.R $1 $2
fi
